...
「ニフティクラウド C4SA（シーフォーエスエー）」はクラウドアプリケーション開発・運用プラットフォームです。「ニフティクラウド C4SA」はPython、PHP、Ruby、Perlなど様々な言語や、Tornado、Django、CakePHP、RoR、Catlystなど多くのフレームワークに対応しており、サーバーを意識することなくブラウザ上でWEBアプリケーション構築、デプロイ、公開が可能です。さらに、今後node.jsやJavaなどの言語にも対応する予定です。
